...
<aside id="leftsidebar" class="sidebar">
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-home"></i><span>داشبورد</span></a>
                <ul class="ml-menu">
                    <li class="active"><a href="index.html">اصلی</a> </li>
                    <li><a href="dashboard-rtl.html"> راست به چپ </a></li>
                    <li><a href="index2.html"> افقی </a></li>
                    <li><a href="ec-dashboard.html"> تجارت الکترونیک </a></li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>رابط کاربری (UI )</span> </a>
                <ul class="ml-menu">
                    ...
                    <li> <a href="notifications.html">اعلان ها (Notifications)</a></li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>فرم ها</span> </a>
                <ul class="ml-menu">
                    ...
                    <li><a href="form-examples.html">نمونه فرم</a> </li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span> تجارت الکترونیک </span> </a>
                <ul class="ml-menu">
                    ...
                    <li> <a href="ec-product-List.html"> لیست محصولات </a></li>
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-map"></i><span> نقشه ها </span> </a>
                <ul class="ml-menu">
